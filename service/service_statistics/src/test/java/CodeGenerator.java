...
public class CodeGenerator {
    ...
    public void run() {
        ...
        packageConfig.setModuleName("staservice"); // 父包下新建 generator 包,不配置为根目录下
        ...
        strategyConfig.setInclude("statistics_daily"); // 生成多张表格式
//        strategyConfig.setTablePrefix("t"+"_"); //生成时去掉表前缀 t,根据实际情况填写
